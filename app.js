...
//Middleware
app.use(cors({ credentials: true, origin: ['http://localhost:3001', 'http://localhost:3001', 'https://bdo-stuff.netlify.app/', 'https://bdo-api-helper.herokuapp.com'], allowedHeaders: ['Content-Type'] }));
